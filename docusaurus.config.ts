...
const config: Config = {
  title: 'Airbus Knowledge Transfer',
  tagline: 'Centralized docs, playbooks, and onboarding for teams',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      links: [
        {
          ...
          items: [
            ...
            {label: 'Runbooks', to: '/docs/runbooks/intro'},
          ],
        },
        {
          title: 'Community',
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Airbus. Built with Docusaurus.`,
    },
    prism: {
